...
akismet {
    key = ""
    site = "http://localhost" // eg http://www.jworks.nl/blog
    provider = "rest.akismet.com"  // or api.antispam.typepad.com
}

// Added by the Spring Security Core plugin:
grails.plugins.springsecurity.userLookup.userDomainClassName = 'ch.fritscher.anhecdotes.User'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'ch.fritscher.anhecdotes.UserRole'
grails.plugins.springsecurity.authority.className = 'ch.fritscher.anhecdotes.Role'
...
grails.plugins.springsecurity.ui.register.emailFrom = 'do.not.reply@hec100.ch'
