            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="comment.anecdote.label" default="Anecdote" /></td>
                            
                            <td valign="top" class="value"><g:link controller="anecdote" action="show" id="${commentInstance?.anecdote?.id}">${commentInstance?.anecdote?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${commentInstance?.status?.encodeAsHTML()}</td>
